        ...
        >
          <div className="space-y-2">
            ...
            <div className="pt-2 md:pt-4">
              <button onClick={()=>router.push(data.redirectTo)} className="mt-4 px-4 py-2.5 cursor-pointer rounded-full border-2 border-red-500 text-black text-[15px] font-normal hover:bg-red-500 hover:text-white transition-colors duration-200">
                {data.btn_Text}
              </button>
            </div>
          </div>
