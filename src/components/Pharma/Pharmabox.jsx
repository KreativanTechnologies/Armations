    ...
    <>
      ...
      <div className="flex flex-col md:flex-row md:items-center bg-white m-0 p-0">
        ...
        <div className="w-full md:w-1/2 space-y-4 text-black p-6">
          ...
          <p>Automation for the Plastic Industry transforms production processes with precision and efficiency. Our advanced automation solutions are designed to enhance every stage of plastic manufacturing.
